-- Update image prompt title to include "Image Prompt - " prefix
...
If people or notes weren''t provided, infer what you can from the transcript. Focus on extracting actionable information.';
    ...
    -- Image prompt content (UPDATED: added "Image Prompt - " prefix to title)
...
-- Update comment
COMMENT ON FUNCTION public.initialize_example_prompts() IS 'Creates 4 example prompts for new users: Welcome (pinned, 2 versions), Developer, Productivity (with variables), and Image Prompt - Cinematic Scene Generator. Runs automatically on user signup.';
