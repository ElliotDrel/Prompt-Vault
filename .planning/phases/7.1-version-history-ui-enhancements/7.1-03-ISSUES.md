...
**Note:** NEEDS REWORK in UAT-012 - Current logic compares content, but since "Current" and "latest version" are treated separately, you can still revert to the latest version (which is nonsensical). Fix: hide Revert button on latest version by version number, not content comparison.
...
**Open Issues:** 4 (1 Blocker, 2 Major, 1 Minor) + 2 Superseded
