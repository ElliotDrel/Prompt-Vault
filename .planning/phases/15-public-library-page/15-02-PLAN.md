...
**Post-plan note (15-FIX):**
- URL-based author filter was removed in favor of unified search.
- Author click now inserts the author name into search (overwrites existing search).
- Issue 10 tracks restoring dedicated author filter chips in Phase 15.1.
</context>
