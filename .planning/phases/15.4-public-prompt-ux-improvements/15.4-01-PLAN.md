...
2. When 'copyEvents' is received, use React Query's `invalidateQueries` method to refresh the copy history list (this triggers refetch without showing loading spinners)
