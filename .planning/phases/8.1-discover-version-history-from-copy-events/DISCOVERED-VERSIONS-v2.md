# Discovered Version History from Copy Events (v2 - Fresh Analysis)

**Analysis date:** 2026-01-13
**Total prompts analyzed:** 38 (prompts with at least 1 copy event)
...
| Metric | Count |
|--------|-------|
| Total prompts with copy events | 38 |
| Prompts with discovered historical versions | 24 |
| Prompts with NO version changes | 14 |
| Total historical versions to insert | ~58 |
...
## Prompts with Discovered Versions (24 prompts)
...
**Current differs:** YES - Title changed to "V1 - PR Comment Review", body has additional text about duplicates and numbered list output
...
**Current differs:** YES - Current has 12781 chars (added Comment Filtering Rules, Known Reviewers, Deduplication Rules, Verification Checklist)
...
**Current differs:** YES - Title has " - school" suffix added, body has "(L{lecture_number})" format
...
| ver | title | body | variables | created_at |
|-----|-------|------|-----------|------------|
| 0 | create comprehensive notes (use study mode) - focus on transcript | (original without title prefixes/suffixes) | `["Lecture Number", "Lecture Transcript", "Lecture Slides"]` | 2025-10-04T... |
...
| ver | title | body | variables | created_at |
|-----|-------|------|-----------|------------|
| 0 | Better ChatGPT Titles | (original without FIX THESE section) | `[]` | 2025-11-15T... |
...
1. [ ] Review prompts with discovered versions - do changes look correct?
2. [ ] Review prompts where current differs from last copy - note for potential data loss
3. [ ] Confirm version numbering strategy (0, 1, 2... for discovered, existing v1 becomes highest)
4. [ ] Verify timestamps align with when edits were made

---

*Generated by Phase 8.1 - Version History Discovery (Fresh Analysis v2)*
