...
2. **Begin Stage 1:** Launch sub-agents for first batch of prompts
3. **Iterate:** Process all 40 prompts in parallel batches
4. **Verify:** Main agent reviews all reports
5. **Generate:** Create migration SQL
6. **Apply:** Run migration and verify
